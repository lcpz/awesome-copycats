...
memwidget = lain.widgets.mem({
    settings = function()
        widget:set_text("内存 " .. mem_now.used .. " ")
    end
})
...
tempwidget = lain.widgets.temp({
    settings = function()
        widget:set_text("温度 " .. coretemp_now .. "°C ")
    end
})
...
fswidget = lain.widgets.fs({
    settings  = function()
        widget:set_text("硬盘 " .. fs_now.used .. "% ")
    end
})
...
batwidget = lain.widgets.bat({
    settings = function()
        ...
        widget:set_markup("电池 " .. bat_now.perc .. "% ")
    end
})
...
volumewidget = lain.widgets.alsa({
    settings = function()
        ...
        widget:set_text("声音 " .. volume_now.level .. "% ")
    end
})
